...
SELECT
  ...
  name,
  surname
FROM customer_analytics.1-customer_dataset;

-- 2. Vérification des valeurs distinctes
SELECT DISTINCT name FROM customer_analytics.1-customer_dataset;
SELECT DISTINCT surname FROM customer_analytics.1-customer_dataset;
SELECT DISTINCT id FROM customer_analytics.1-customer_dataset;

-- 3. Clients avec 3 commandes
SELECT * FROM customer_analytics.1-customer_dataset
