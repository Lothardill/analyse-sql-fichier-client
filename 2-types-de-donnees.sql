...
SELECT * FROM stock_analysis.raw_circle_stock;

-- 2. Identification de la clé primaire
-- On vérifie que model_id contient des valeurs uniques
SELECT DISTINCT model_id FROM stock_analysis.raw_circle_stock;
...
FROM stock_analysis.raw_circle_stock;
...
SELECT CAST(date_creation AS DATE) AS date_creation
FROM stock_analysis.validated_circle_stock;
